...
model_definitions <- list(
  Model1.1 = "occu(~ (1 | weeks) ~ (1 | PatchID), data = umf, control = list(maxit = 1000))",
  Model1.2 = "occu(~ (1 | weeks) + VegetationCover ~ (1 | PatchID), data = umf, control = list(maxit = 1000))",
  Model1.3 = "occu(~ (1 | weeks) + TreeDensity ~ (1 | PatchID), data = umf, control = list(maxit = 1000))",
  Model1.4 = "occu(~ (1 | weeks) + VegetationCover + TreeDensity ~ (1 | PatchID), data = umf, control = list(maxit = 1000))",
  Model2.1 = "occu(~ (1 | weeks) ~ (1 | PatchID) + Matrix, data = umf, control = list(maxit = 1000))",
  Model2.2 = "occu(~ (1 | weeks) + VegetationCover ~ (1 | PatchID) + Matrix, data = umf, control = list(maxit = 1000))",
  Model2.3 = "occu(~ (1 | weeks) + TreeDensity ~ (1 | PatchID) + Matrix, data = umf, control = list(maxit = 1000))",
  Model2.4 = "occu(~ (1 | weeks) + VegetationCover + TreeDensity ~ (1 | PatchID) + Matrix, data = umf, control = list(maxit = 1000))",
  Model3.1 = "occu(~ (1 | weeks) ~ (1 | PatchID) + log_Area, data = umf, control = list(maxit = 1000))",
  Model3.2 = "occu(~ (1 | weeks) + VegetationCover ~ (1 | PatchID) + log_Area, data = umf, control = list(maxit = 1000))",
  Model3.3 = "occu(~ (1 | weeks) + TreeDensity ~ (1 | PatchID) + log_Area, data = umf, control = list(maxit = 1000))",
  Model3.4 = "occu(~ (1 | weeks) + VegetationCover + TreeDensity ~ (1 | PatchID) + log_Area, data = umf, control = list(maxit = 1000))",
  Model4.1 = "occu(~ (1 | weeks) ~ (1 | PatchID) + log_Area + Matrix, data = umf, control = list(maxit = 1000))",
  Model4.2 = "occu(~ (1 | weeks) + VegetationCover ~ (1 | PatchID) + log_Area + Matrix, data = umf, control = list(maxit = 1000))",
  Model4.3 = "occu(~ (1 | weeks) + TreeDensity ~ (1 | PatchID) + log_Area + Matrix, data = umf, control = list(maxit = 1000))",
  Model4.4 = "occu(~ (1 | weeks) + VegetationCover + TreeDensity ~ (1 | PatchID) + log_Area + Matrix, data = umf, control = list(maxit = 1000))",
  Model5.1 = "occu(~ (1 | weeks) ~ (1 | PatchID) + log_Area * Matrix, data = umf, control = list(maxit = 1000))",
  Model5.2 = "occu(~ (1 | weeks) + VegetationCover ~ (1 | PatchID) + log_Area * Matrix, data = umf, control = list(maxit = 1000))",
  Model5.3 = "occu(~ (1 | weeks) + TreeDensity ~ (1 | PatchID) + log_Area * Matrix, data = umf, control = list(maxit = 1000))",
  Model5.4 = "occu(~ (1 | weeks) + VegetationCover + TreeDensity ~ (1 | PatchID) + log_Area * Matrix, data = umf, control = list(maxit = 1000))",
  Model6.1 = "occu(~ (1 | weeks) ~ (1 | PatchID) + log_Area + Matrix + min_distance_to_next_patch_km, data = umf, control = list(maxit = 1000))",
  Model6.2 = "occu(~ (1 | weeks) + VegetationCover ~ (1 | PatchID) + log_Area + Matrix + min_distance_to_next_patch_km, data = umf, control = list(maxit = 1000))",
  Model6.3 = "occu(~ (1 | weeks) + TreeDensity ~ (1 | PatchID) + log_Area + Matrix + min_distance_to_next_patch_km, data = umf, control = list(maxit = 1000))",
  Model6.4 = "occu(~ (1 | weeks) + VegetationCover + TreeDensity ~ (1 | PatchID) + log_Area + Matrix + min_distance_to_next_patch_km, data = umf, control = list(maxit = 1000))",
  Model7.1 = "occu(~ (1 | weeks) ~ (1 | PatchID) + log_Area * Matrix + min_distance_to_next_patch_km, data = umf, control = list(maxit = 1000))",
  Model7.2 = "occu(~ (1 | weeks) + VegetationCover~ (1 | PatchID) + log_Area * Matrix + min_distance_to_next_patch_km, data = umf, control = list(maxit = 1000))",
  Model7.3 = "occu(~ (1 | weeks) + TreeDensity ~ (1 | PatchID) + log_Area * Matrix + min_distance_to_next_patch_km, data = umf, control = list(maxit = 1000))",
  Model7.4 = "occu(~ (1 | weeks) + VegetationCover + TreeDensity ~ (1 | PatchID) + log_Area * Matrix + min_distance_to_next_patch_km, data = umf, control = list(maxit = 1000))"
)
...
for (species in species_of_interest) {
  ...
  for (model_name in names(model_definitions)) {
    ...
    if (!is.null(model)) {
      ...
      print(species)
      print(model_formula)
      Gof <- mb.gof.test(model, nsim = 200)
